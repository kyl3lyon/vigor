...
# Planning domain
class WorkoutTemplateRepository(Protocol):
...
class WorkoutExerciseTemplateRepository(Protocol):
...
class TrainingProgramRepository(Protocol):
...
class ProgramPhaseRepository(Protocol):
...
class ProgramEnrollmentRepository(Protocol):
...
class ScheduledWorkoutRepository(Protocol):
